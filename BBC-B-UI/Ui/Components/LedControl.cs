...
///     controls:LedControl ActiveLed="{Binding ActiveLedItem}" Leds="{Binding Colors}" LedOrientation="Vertical"
///     Width="60"
/// </example>
public class LedControl : ContentControl
{
    ...
    {
        get => (List<Color>)GetValue(LedsProperty);
    ...
    private void LoadLeds(object sender, RoutedEventArgs e)
    {
        ...
        foreach (var color in Leds)
        {
            ...
            ellipse.Stroke = srgb;
            // Color of led
            var rgb = new RadialGradientBrush(new GradientStopCollection
            {
            ...
            rgb.GradientOrigin = new Point(0.5d, 0.5d);
            rgb.Center = new Point(0.5d, 0.5d);
            rgb.RadiusX = 0.5d;
            rgb.RadiusY = 0.5d;
            ellipse.Fill = rgb;
